...
_RAW = [
    ...
    ("barfi", "Classic Santra Burfi", 50, "barfi", "Bestseller", "Traditional orange burfi, melt-in-mouth sweet. Per piece."),
    ("barfi", "Santra Pistachio Burfi", 60, "barfi", None, "Orange burfi topped with crushed pistachio. Per piece."),
    ("barfi", "Santra Coconut Burfi", 55, "barfi", None, "Coconut & orange zest infused burfi. Per piece."),
    ("barfi", "Santra Dryfruit Burfi", 70, "barfi", "Gift", "Loaded with almonds, cashews & orange peel. Per piece."),
]
